...
int main() {
    ...
    Texture dirt{
        "/home/Wihy/Projects/CPP/FlightSimulatorHopefully/resources/textures/dirt.png", GL_TEXTURE_2D, GL_TEXTURE0,
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        test.draw(shaderProgram, camera, {0, 0, 0}, {0, 0, 89});
        ...
        std::string orientation = std::format("Orientation({}, {}, {})", camera.Orientation.x, camera.Orientation.y,
